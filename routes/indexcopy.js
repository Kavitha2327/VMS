...
router.get('/getBranchdata', function(req,res){
  ...
  if(req.session && req.session.user){
    ...
    if(req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc' || req.session.user.username=='fuel') {
      ...
      branch.find({"name":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getStagedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      stages.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoutedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      route.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoutedetailsdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      routedetails.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getStaffmeetingdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      staffmeeting.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getBranchvehicledata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      branchvehicle.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.post('/EditBranchvehicle', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  branchvehicle.update({"_id":id},{$set:{"society":req.body.society,"branch":req.body.branch,"staffname":req.body.staffname,"vehicleregno":req.body.vehicleregno,"model":req.body.model,"purchasedate":req.body.purchasedate,"servicedate":req.body.servicedate}}, function(err,docs){
    res.send(docs)
  })
});
...
router.get('/getBusfilldata', function(req,res){
  if(req.session && req.session.user){
    ...
    //console.log(req.session.user.branch)
      ...
      busfill.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/vehicletripexceed', function(req,res){
  ...
  res.locals.user = req.session.user;
    if(req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
        ...
        vehicletripdata.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","KKD DEGREE","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","ADITYA PUBLIC SCHOOL SRINAGAR","KKD IIT","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES","KKD INTER"]},"result":/exceed/, "uploaddate":date}, function(err,docs32){
        res.send(docs32)
        });
      }
  }
...
router.get('/getVehicleTripdata', function(req,res){
  ...
  // console.log(date);
    ...
    if((req.session.user.username=='vms') || (req.session.user.username=='vc')) {
      ...
      vehicletripdata.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","KKD DEGREE","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","ADITYA PUBLIC SCHOOL SRINAGAR","KKD IIT","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES","KKD INTER"]}, "uploaddate":date}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.post('/gettingvehicletripdata', function(req,res){
  ...
  if(req.session.user.username=='vms') {
      ...
      vehicletripdata.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","KKD DEGREE","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","ADITYA PUBLIC SCHOOL SRINAGAR","KKD IIT","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES","KKD INTER"]}, "Timestamp":{$gte:ftime,$lte:ttime}}, function(err,docs){
      res.send(docs)
      });
    }
 }   
...
router.get('/getBusremarks', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      busremarks.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleAccident', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicleaccident.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleservice', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicleservice.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRtadata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      rta.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
//editing Rta
router.post('/EditRta', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
    society : req.body.society,
...
router.get('/RtaExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      rta.find({"expireddate":date,"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getInsurancedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insurance.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }insurance
}
...
//editing Insurance
router.post('/EditInsurance', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
    society : req.body.society,
...
router.get('/InsuranceExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insurance.find({"status":"on","branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getPollutiondata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      pollution.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}pollution
...
//editing Pollution
router.post('/EditPollution', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
    society : req.body.society,
...
router.get('/PollutionExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      pollution.find({"status":"on","branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getFitnessdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      fitness.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
//editing Fitness
router.post('/EditFitness', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
      society : req.body.society,
...
router.get('/FitnessExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      fitness.find({"status":"on","branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoadtaxdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadtax.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}roadtax
...
//editing roadtax
router.post('/EditRoadtax', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
    society : req.body.society,
...
router.get('/RoadtaxExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadtax.find({"status":"on","branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoadpermitdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadpermit.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
//editing roadpermit
router.post('/EditRoadpermit', function(req,res){
  //console.log(req.body._id)
  var id = req.body._id;
  var data = {
    society : req.body.society,
...
router.get('/RoadpermitExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadpermit.find({"status":"on","branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getInsuranceClaimdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insuranceclaim.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleChallandata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehiclechallan.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getNewvehicletyre', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicletyres.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRepvehicletyre', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      replacedvehicle.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getDailyvehicle', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      dailyvehicle.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehiclerepair', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehiclerepair.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getvcrdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vcr.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehiclewisedata', function(req,res){
 if(req.session && req.session.user){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    vehiclewisebattery.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getbatterychangedata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    batterychangereport.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getTyrestatusdata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    tyrestatus.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getBusbreakedowndata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    busbreakdown.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES"]}}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.post('/getbusbreakereportdates', function(req,res){
  ...
  if(req.session.user.username=='vms') {
      ...
      busbreakdown.find({"branch":{$in:["KKD DEGREE-AA","KKD DEGREE-SES","KKD DEGREE","ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA","ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES","ADITYA PUBLIC SCHOOL SRINAGAR","KKD IIT","KKD IIT-AA","KKD IIT-SES","KKD INTER-AA","KKD INTER-SES","KKD INTER"]}, "timestamp":{$gte:ftime,$lte:ttime}}, function(err,docs){
      res.send(docs)
      });
    }
 }   
