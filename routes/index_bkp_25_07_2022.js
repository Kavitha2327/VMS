...
router.get('/getBranchdata', function(req,res){
  ...
  if(req.session && req.session.user){
    ...
    if(req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc' || req.session.user.username=='fuel') {
      ...
      branch.find({"name":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getStagedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      stages.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoutedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      route.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoutedetailsdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      routedetails.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getStaffmeetingdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      staffmeeting.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getBranchvehicledata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      branchvehicle.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getBusfilldata', function(req,res){
  if(req.session && req.session.user){
    ...
    //console.log(req.session.user.branch)
      ...
      busfill.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/vehicletripexceed', function(req,res){
  ...
  res.locals.user = req.session.user;
    if(req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
        ...
        vehicletripdata.find({"branch":/Peddapuram/,"result":/exceed/, "uploaddate":date}, function(err,docs32){
        res.send(docs32)
        });
      }
  }
...
router.get('/getVehicleTripdata', function(req,res){
  ...
  // console.log(date);
    ...
    if((req.session.user.username=='vms') || (req.session.user.username=='vc')) {
      ...
      vehicletripdata.find({"branch":/Peddapuram/, "uploaddate":date}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.post('/gettingvehicletripdata', function(req,res){
  ...
  if(req.session.user.username=='vms') {
      ...
      vehicletripdata.find({"branch":/Peddapuram/, "Timestamp":{$gte:ftime,$lte:ttime}}, function(err,docs){
      res.send(docs)
      });
    }
 }   
...
router.get('/getBusremarks', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      busremarks.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleAccident', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicleaccident.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleservice', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicleservice.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRtadata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      rta.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/RtaExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      rta.find({"expireddate":date,"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getInsurancedata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insurance.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/InsuranceExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insurance.find({"status":"on","branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getPollutiondata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      pollution.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/PollutionExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      pollution.find({"status":"on","branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getFitnessdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      fitness.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/FitnessExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      fitness.find({"status":"on","branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoadtaxdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadtax.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/RoadtaxExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadtax.find({"status":"on","branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRoadpermitdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadpermit.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/RoadpermitExpired', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      roadpermit.find({"status":"on","branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getInsuranceClaimdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      insuranceclaim.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehicleChallandata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehiclechallan.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getNewvehicletyre', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehicletyres.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getRepvehicletyre', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      replacedvehicle.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getDailyvehicle', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      dailyvehicle.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehiclerepair', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vehiclerepair.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getvcrdata', function(req,res){
  if(req.session && req.session.user){
    ...
    if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
      ...
      vcr.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.get('/getVehiclewisedata', function(req,res){
 if(req.session && req.session.user){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    vehiclewisebattery.find({"branch":/Peddapuram/}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getbatterychangedata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    batterychangereport.find({"branch":/Peddapuram/}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getTyrestatusdata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    tyrestatus.find({"branch":/Peddapuram/}, function(err,docs){
    res.send(docs)
    });
  }
}
...
router.get('/getBusbreakedowndata', function(req,res){
  ...
  if (req.session.user.username=='vms' || req.session.user.username=='vmskkd' || req.session.user.username=='vc') {
    ...
    res.send(docs)
      ...
      busbreakdown.find({"branch":/Peddapuram/}, function(err,docs){
      res.send(docs)
      });
    }
}
...
router.post('/getbusbreakereportdates', function(req,res){
  ...
  if(req.session.user.username=='vms') {
      ...
      busbreakdown.find({"branch":/Peddapuram/, "timestamp":{$gte:ftime,$lte:ttime}}, function(err,docs){
      res.send(docs)
      });
    }
 }   
