...
router.get('/getHeavyVehicleinfo', function(req,res){
  vehicleinfo.find({"type":"BUS", "make":{$in:["EICHER", "ASHOK LEYLAND","TATA","FORCE","EICHER"]}}, function(err,docs){
    //console.log(docs)
    res.send(docs)
  })
})
...
// ----------------------------------------Ad Bule-------------------------------------------------------------------
router.post('/AdBlueData', function(req,res){
  //console.log(req.body)
  var name = req.body.name;
  //console.log(name);
