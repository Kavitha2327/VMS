...
router.get('/getBranchdata', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc' || req.session.user.username == 'fuel') {
      ...
      branch.find({ "name": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
      ...
      branch.find({ "name": { $in: ["MARIKAVALASA-SES", "MARIKAVALASA-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }

    else if (req.session.user.username == 'adckkdiit') {
      branch.find({ "name": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      branch.find({ "name": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    // Aditya Thaksha
...
router.get('/getRepairBillsdata', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      repairbills.find({ "branch": { $in: ["KKD ENGINEERING-AA", "KKD ENGINEERING-SES", "NON LOCAL ENGINEERING-AA", "NON LOCAL ENGINEERING-SES", "RJY ENGINEERING-AA", "RJY ENGINEERING-SES", "MANDAPETA ENGINEERING-AA", "MANDAPETA ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkd') {
      repairbills.find({ "branch": { $in: ["KKD DEGREE-AA", "KKD DEGREE-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'srikkd') {
      repairbills.find({ "branch": { $in: ["ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA", "ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'ajckkd') {
      repairbills.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      repairbills.find({ "branch": { $in: ["PEDDAPURAM-AA", "PEDDAPURAM-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcmkvs') {
      repairbills.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      repairbills.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      repairbills.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      repairbills.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      repairbills.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
    ...
    // machilipatnam
      ...
      repairbills.find({ "branch": /MATCHILI PATNAM DEGREE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    // NIDADHAVOLU
...
router.post('/getRepairBillsdata1', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      repairbills.find({ "vehicleregno": req.body.val, "branch": /JAGANNAICKPUR/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcamp') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /AMALAPURAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcbvrm') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /BHIMAVARAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adceluru') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /ELURU/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcgmd') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /MAMIDADA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcgwk') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /GAJUWAKA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adclakshya') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /LAKSHYA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcmdp') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /MANDAPETA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcnsp') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /NARASAPURAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpkl') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /PALAKOL/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcptp') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /PITHAPURAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcrjyd') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /RJY DEGREE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcsklm') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /SRIKAKULAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adctpg') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /TADEPALLIGUDEM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adctuni') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": /TUNI/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcengg') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": { $in: ["KKD ENGINEERING-AA", "KKD ENGINEERING-SES", "NON LOCAL ENGINEERING-AA", "NON LOCAL ENGINEERING-SES", "RJY ENGINEERING-AA", "RJY ENGINEERING-SES", "MANDAPETA ENGINEERING-AA", "MANDAPETA ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkd') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": { $in: ["KKD DEGREE-AA", "KKD DEGREE-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'srikkd') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": { $in: ["ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA", "ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'ajckkd') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      repairbills.find({ "vehicleregno": req.body.val, "branch": { $in: ["PEDDAPURAM-AA", "PEDDAPURAM-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcmkvs') {
...
router.get('/generateVoucherNumber', function (req, res) {
  ...
  repairbills.aggregate([
    ...
    if (result && result.length > 0 && result[0].maxVoucher !== null) {
      ...
      console.log(`Found ${result[0].totalVouchers} total vouchers across all branches`);
...
router.get('/getStagedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      stages.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      stages.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      stages.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      stages.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getRoutedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      route.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      route.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      route.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      route.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    // Aditya Thaksha
...
router.get('/getRoutedetailsdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      routedetails.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      routedetails.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      routedetails.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      routedetails.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      routedetails.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    // Aditya Thaksha
    else if (req.session.user.username == 'adcats') {
      routedetails.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getOfficedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      officestaff.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      officestaff.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      officestaff.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      officestaff.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      officestaff.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      console.log("here")
      officestaff.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getStaffmeetingdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      staffmeeting.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      staffmeeting.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      staffmeeting.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      staffmeeting.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      staffmeeting.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      staffmeeting.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getBusStaffdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      busstaff.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      busstaff.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      busstaff.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      busstaff.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      busstaff.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getBusCleanerdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      buscleaner.find({ "branch": { $in: ["KKD ENGINEERING-AA", "KKD ENGINEERING-SES", "NON LOCAL ENGINEERING-AA", "NON LOCAL ENGINEERING-SES", "RJY ENGINEERING-AA", "RJY ENGINEERING-SES", "MANDAPETA ENGINEERING-AA", "MANDAPETA ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkd') {
      buscleaner.find({ "branch": { $in: ["KKD DEGREE-AA", "KKD DEGREE-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'srikkd') {
      buscleaner.find({ "branch": { $in: ["ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA", "ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'ajckkd') {
      buscleaner.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      buscleaner.find({ "branch": { $in: ["PEDDAPURAM-AA", "PEDDAPURAM-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcmkvs') {
      buscleaner.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      buscleaner.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      buscleaner.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      buscleaner.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getHeavyVehicleinfo', function (req, res) {
  vehicleinfo.find({ "type": "BUS", "make": { $in: ["EICHER", "ASHOK LEYLAND", "TATA", "FORCE", "SWARAJ AC", "SWARAJ"] } }, function (err, docs) {
    // console.log(docs)
    res.send(docs)
  })
})
...
router.get('/getBranchvehicledata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      branchvehicle.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      branchvehicle.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      branchvehicle.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      branchvehicle.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      branchvehicle.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      branchvehicle.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getBusfilldata111', function (req, res) {
  ...
  busfill.find({ 'regno': /^AP/ }, function (err, docs) {
    if (err) {
      ...
      busfill.distinct('regno', { 'regno': { $ne: null } }, { "regno": /^AP/ }, function (err1, docs1) {
        if (docs1 != "null") {
          // console.log(docs1)
          res.send(docs1)
...
router.get('/getBusfilldata', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      busfill.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      busfill.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      busfill.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      busfill.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/vehicletripexceed', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehicletripdata.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicletripdata.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicletripdata.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicletripdata.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicletripdata.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicletripdata.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      vehicletripdata.find({ "branch": /GUDIVADA/ },
        function (err, docs) {
          res.send(docs)
        });
    }
...
router.get('/getVehicleTripdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if ((req.session.user.username == 'vms') || (req.session.user.username == 'vc')) {
      ...
      vehicletripdata.find({ "branch": { $in: ["KKD DEGREE-AA", "KKD DEGREE-SES"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'srikkd') {
      vehicletripdata.find({ "branch": { $in: ["ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA", "ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'ajckkd') {
      vehicletripdata.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicletripdata.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicletripdata.find({ "branch": /KAKINADA HEAD OFFICE/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicletripdata.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicletripdata.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] }, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicletripdata.find({ "branch": /ADITYA THAKSH SCHOOL-AA/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      vehicletripdata.find({ "branch": /ANAKAPALI-SES/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      vehicletripdata.find({ "branch": /GUDIVADA/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      vehicletripdata.find({ "branch": /NIDADHAVOLU/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    else if (req.session.user.username == 'Adcongole') {
      vehicletripdata.find({ "branch": /ONGOLE/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // VIZIANAGARAM
      ...
      vehicletripdata.find({ "branch": /VIZIANAGARAM/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      vehicletripdata.find({ "branch": /MATCHILI PATNAM/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      vehicletripdata.find({ "branch": /VIJAYAWADA/, "uploaddate": date }, function (err, docs) {
        res.send(docs)
      });
    }
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms') {
      ...
      vehicletripdata.find({
        "branch": {
          $in: ["KKD ENGINEERING-AA", "KKD ENGINEERING-SES", "NON LOCAL ENGINEERING-AA", "NON LOCAL ENGINEERING-SES", "RJY ENGINEERING-AA",
            "RJY ENGINEERING-SES", "MANDAPETA ENGINEERING-AA", "MANDAPETA ENGINEERING-SES"]
    ...
    // }
      ...
      vehicletripdata.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] }, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicletripdata.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] }, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicletripdata.find({ "branch": /KAKINADA HEAD OFFICE/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicletripdata.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] }, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicletripdata.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] }, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicletripdata.find({ "branch": /ADITYA THAKSH SCHOOL-AA/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      vehicletripdata.find({ "branch": /ANAKAPALI-SES/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      vehicletripdata.find({ "branch": /GUDIVADA/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      vehicletripdata.find({ "branch": /NIDADHAVOLU/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    else if (req.session.user.username == 'Adcongole') {
      vehicletripdata.find({ "branch": /ONGOLE/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // VIZIANAGARAM
      ...
      vehicletripdata.find({ "branch": /VIZIANAGARAM/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      vehicletripdata.find({ "branch": /MATCHILI PATNAM/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      vehicletripdata.find({ "branch": /VIJAYAWADA/, "Timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getBusremarks', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      busremarks.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      busremarks.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      busremarks.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      busremarks.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      busremarks.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getVehicleAccident', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehicleaccident.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicleaccident.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicleaccident.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicleaccident.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicleaccident.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicleaccident.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/getVehicleservice1', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      vehicleservice.find({ "vehicleregno": req.body.val }, function (err, docs) {
        ...
        for (i = 0; i < docs.length; i++) {
          ...
          vehicletripdata.findOne({ "regno": vehicleregno }, { sort: { Timestamp: -1 } }, function (err1, docs1) {
            if (docs1) {
              var regno = docs1.regno ? docs1.regno : ''
              let myobj = { newcmr: docs1.cmr };
              vehicleservice.update({ "vehicleregno": regno }, { $set: { "newcmr": docs1.cmr } }, { multi: true }, function (err2, docs2) {
                console.log(docs2)
              })
            } else {
              console.log("No document found for vehicleregno: " + vehicleregno);
            }
          })
        }
        console.log(docs);
      ...
      vehicleservice.find({ "vehicleregno": req.body.val, "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicleservice.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicleservice.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicleservice.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicleservice.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicleservice.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getVehicleservice', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehicleservice.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
...
router.get('/getRtadata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      rta.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      rta.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      rta.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      rta.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/EditRta', upload.single('file'), function (req, res) {
  ...
  var b_date = req.body.date.length === 10 ? req.body.date : moment(req.body.date, 'DD-MM-YYYY').format('YYYY-MM-DD');
  var expired_date = req.body.expireddate.length === 10 ? req.body.expireddate : moment(req.body.expireddate, 'DD-MM-YYYY').format('YYYY-MM-DD');
...
router.get('/getInsurancedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      insurance.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      insurance.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      insurance.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      insurance.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      insurance.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/InsuranceExpired', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      insurance.find({ "status": "on", "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      insurance.find({ "status": "on", "branch": { "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      insurance.find({ "status": "on", "branch": { "branch": /KAKINADA HEAD OFFICE/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      insurance.find({ "status": "on", "branch": { "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      insurance.find({ "status": "on", "branch": { "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      insurance.find({ "status": "on", "branch": { "branch": /ADITYA THAKSH SCHOOL-AA/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      insurance.find({ "status": "on", "branch": { "branch": /ANAKAPALI-SES/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      insurance.find({ "status": "on", "branch": { "branch": /GUDIVADA/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      insurance.find({ "status": "on", "branch": { "branch": /NIDADHAVOLU/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    else if (req.session.user.username == 'Adcongole') {
      insurance.find({ "status": "on", "branch": { "branch": /ONGOLE/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // VIZIANAGARAM
      ...
      insurance.find({ "status": "on", "branch": { "branch": /VIZIANAGARAM/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      insurance.find({ "status": "on", "branch": { "branch": /MATCHILI PATNAM/ } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      insurance.find({ "status": "on", "branch": { "branch": /VIJAYAWADA/ } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getPollutiondata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      pollution.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      pollution.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      pollution.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      pollution.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      pollution.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/PollutionExpired', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      pollution.find({ "status": "on", "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      pollution.find({ "status": "on", "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      pollution.find({ "status": "on", "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      pollution.find({ "status": "on", "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      pollution.find({ "status": "on", "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      pollution.find({ "status": "on", "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      pollution.find({ "status": "on", "branch": /ANAKAPALI-SES/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      pollution.find({ "status": "on", "branch": /GUDIVADA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      pollution.find({ "status": "on", "branch": /NIDADHAVOLU/ }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    ...
    // VIZIANAGARAM
      ...
      pollution.find({ "status": "on", "branch": /VIZIANAGARAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      pollution.find({ "status": "on", "branch": /MATCHILI PATNAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      pollution.find({ "status": "on", "branch": /VIJAYAWADA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getFitnessdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      fitness.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      fitness.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      fitness.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      fitness.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/FitnessExpired', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      fitness.find({ "status": "on", "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      fitness.find({ "status": "on", "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      fitness.find({ "status": "on", "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      fitness.find({ "status": "on", "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      fitness.find({ "status": "on", "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      fitness.find({ "status": "on", "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      fitness.find({ "status": "on", "branch": /ANAKAPALI-SES/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      fitness.find({ "status": "on", "branch": /NIDADHAVOLU/ }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    ...
    // VIZIANAGARAM
      ...
      fitness.find({ "status": "on", "branch": /VIZIANAGARAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      fitness.find({ "status": "on", "branch": /MATCHILI PATNAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      fitness.find({ "status": "on", "branch": /VIJAYAWADA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getRoadtaxdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      roadtax.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      roadtax.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      roadtax.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      roadtax.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/RoadtaxExpired', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      roadtax.find({ "status": "on", "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      roadtax.find({ "status": "on", "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      roadtax.find({ "status": "on", "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      roadtax.find({ "status": "on", "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      roadtax.find({ "status": "on", "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      roadtax.find({ "status": "on", "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      roadtax.find({ "status": "on", "branch": /ANAKAPALI-SES/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      roadtax.find({ "status": "on", "branch": /NIDADHAVOLU/ }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    ...
    // VIZIANAGARAM
      ...
      roadtax.find({ "status": "on", "branch": /VIZIANAGARAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      roadtax.find({ "status": "on", "branch": /MATCHILI PATNAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // vijayawada
      ...
      roadtax.find({ "status": "on", "branch": /VIJAYAWADA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getRoadpermitdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      roadpermit.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      roadpermit.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      roadpermit.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      roadpermit.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      roadpermit.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/RoadpermitExpired', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      roadpermit.find({ "status": "on", "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
...
router.get('/getInsuranceClaimdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      insuranceclaim.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      insuranceclaim.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      insuranceclaim.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      insuranceclaim.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      insuranceclaim.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      insuranceclaim.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getVehicleChallandata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehiclechallan.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehiclechallan.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehiclechallan.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehiclechallan.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehiclechallan.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehiclechallan.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getNewvehicletyre', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehicletyres.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehicletyres.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehicletyres.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehicletyres.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehicletyres.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehicletyres.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getRepvehicletyre', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      replacedvehicle.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      replacedvehicle.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      replacedvehicle.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      replacedvehicle.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      replacedvehicle.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      replacedvehicle.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getDailyvehicledata1', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      dailyvehicle.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      dailyvehicle.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      dailyvehicle.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      dailyvehicle.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      dailyvehicle.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      dailyvehicle.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getVehiclerepair', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehiclerepair.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehiclerepair.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehiclerepair.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehiclerepair.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehiclerepair.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehiclerepair.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/getVehiclerepair1', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehiclerepair.find({ "regno": req.body.val, "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
...
router.get('/getvcrdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vcr.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vcr.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      vcr.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vcr.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getVehiclewisedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      vehiclewisebattery.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      vehiclewisebattery.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      vehiclewisebattery.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      vehiclewisebattery.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      vehiclewisebattery.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      vehiclewisebattery.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      vehiclewisebattery.find({ "branch": /ANAKAPALI-SES/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      vehiclewisebattery.find({ "branch": /MATCHILI PATNAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getbatterychangedata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      batterychangereport.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      batterychangereport.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      batterychangereport.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      batterychangereport.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      batterychangereport.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      batterychangereport.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      batterychangereport.find({ "branch": /ANAKAPALI-SES/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // VIZIANAGARAM
      ...
      batterychangereport.find({ "branch": /VIZIANAGARAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      batterychangereport.find({ "branch": /MATCHILI PATNAM/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getTyrestatusdata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      tyrestatus.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      tyrestatus.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      ...
      tyrestatus.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      tyrestatus.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      tyrestatus.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.get('/getBusbreakedowndata', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      busbreakdown.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      ...
      busbreakdown.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      busbreakdown.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      busbreakdown.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      busbreakdown.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      busbreakdown.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/getbusbreakereportdates', function (req, res) {
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms') {
      ...
      busbreakdown.find({ "adckkd": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
    ...
    // Aditya Thaksha
      ...
      busbreakdown.find({ "branch": /ADITYA THAKSH SCHOOL-AA/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // ANAKAPALI DEGREE
      ...
      busbreakdown.find({ "branch": /ANAKAPALI-SES/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // GUDIVADA-DE
      ...
      busbreakdown.find({ "branch": /GUDIVADA/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // NIDADHAVOLU
      ...
      busbreakdown.find({ "branch": /NIDADHAVOLU/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    // ONGOLE
    else if (req.session.user.username == 'Adcongole') {
      busbreakdown.find({ "branch": /ONGOLE/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // VIZIANAGARAM
      ...
      busbreakdown.find({ "branch": /VIZIANAGARAM/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // machilipatnam
      ...
      busbreakdown.find({ "branch": /MATCHILI PATNAM/, "timestamp": { $gte: ftime, $lte: ttime } }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/EditAdBlue', function (req, res) {
  //console.log(req.body._id)
  var id = req.body._id;
  AdBlue.update({ "_id": id }, { $set: { "name": req.body.name } }, function (err, docs) {
    res.send(docs)
  })
});
...
router.post('/getAdBusfilldata', function (req, res) {
  ...
  if (req.session && req.session.user) {
    ...
    if (req.session.user.username == 'vms' || req.session.user.username == 'vmskkd' || req.session.user.username == 'vc') {
      ...
      AdBlueBusfill.find({ "branch": { $in: ["KKD ENGINEERING-AA", "KKD ENGINEERING-SES", "NON LOCAL ENGINEERING-AA", "NON LOCAL ENGINEERING-SES", "RJY ENGINEERING-AA", "RJY ENGINEERING-SES", "MANDAPETA ENGINEERING-AA", "MANDAPETA ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkd') {
      AdBlueBusfill.find({ "branch": { $in: ["KKD DEGREE-AA", "KKD DEGREE-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'srikkd') {
      AdBlueBusfill.find({ "branch": { $in: ["ADITYA PUBLIC SCHOOL (SRI NAGAR)-AA", "ADITYA PUBLIC SCHOOL (SRI NAGAR)-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'ajckkd') {
      AdBlueBusfill.find({ "branch": { $in: ["KKD INTER-AA", "KKD INTER-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcpdp') {
      AdBlueBusfill.find({ "branch": { $in: ["PEDDAPURAM-AA", "PEDDAPURAM-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcmkvs') {
      AdBlueBusfill.find({ "branch": { $in: ["MARIKAVALASA-AA", "MARIKAVALASA-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcho') {
      AdBlueBusfill.find({ "branch": /KAKINADA HEAD OFFICE/ }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adckkdiit') {
      AdBlueBusfill.find({ "branch": { $in: ["KKD IIT-SES", "KKD IIT-AA"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    else if (req.session.user.username == 'adcadmin') {
      AdBlueBusfill.find({ "branch": { $in: ["SURAMPALEM-ENGINEERING-AA", "SURAMPALEM-ENGINEERING-SES"] } }, function (err, docs) {
        res.send(docs)
      });
    }
    ...
    // Aditya Thaksha
      ...
      AdBlueBusfill.find({ "branch": /ADITYA THAKSH SCHOOL-AA/ }, function (err, docs) {
        res.send(docs)
      });
    }
...
router.post('/gettingAdbusfilldata', function (req, res) {
  ...
  AdBlueBusfill.find({ "date": { $gte: fdate, $lte: tdate } }, function (err, docs) {
    if (docs) {
      console.log(docs)
      res.send(docs)
    }
